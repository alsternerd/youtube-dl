...
Windows users can [download an .exe file](https://yt-dl.org/latest/youtube-dl.exe) and place it in any location on their [PATH], e.g. into `%USERPROFILE%\AppData\Local\` (https://en.wikipedia.org/wiki/PATH_%28variable%29).
Do NOT use `%SYSTEMROOT%\System32` (e.g. **do not** put in `C:\Windows\System32`).
